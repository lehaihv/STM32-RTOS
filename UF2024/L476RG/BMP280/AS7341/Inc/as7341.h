...
#else
#error "AS7341 library was tested only on STM32F0, STM32F1, STM32F3, STM32F4, STM32F7, STM32L0, STM32L1, STM32L4, STM32H7, STM32G0, STM32G4, STM32WB, STM32C0 MCU families. Please modify as7341.h if you know what you are doing. Also please send a pull request if it turns out the library works on other MCU's as well!"
#endif


/* vvv I2C config vvv */

#ifndef AS7341_I2C_PORT
#define AS7341_I2C_PORT        hi2c1
#endif

#ifndef AS7341_I2C_ADDR
#define AS7341_I2C_ADDR        (0x39 << 1)
#endif

/* ^^^ I2C config ^^^ */

#if defined(AS7341_USE_I2C)
extern I2C_HandleTypeDef AS7341_I2C_PORT;
#else
#error "You should define AS7341_USE_I2C macro!"
#endif
